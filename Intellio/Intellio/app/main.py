...
"""
logger = logging.getLogger("I.N.T.E.L.L.I.O")
...
def print_title():
    """Print the INTELLIO AI ASCII art title."""
    title = """
   ╔══════════════════════════════════════════════════════════╗
   ║                                                          ║
   ║   ██╗███╗   ██╗████████╗███████╗██╗     ██╗     ██╗ ██████╗   ║
...
async def lifespan(app: FastAPI):
    ...
    print_title()
    logger.info("=" * 60)
    logger.info("I.N.T.E.L.L.I.O - Starting Up...")
    logger.info("=" * 60)
    ...
    try:
        ...
        logger.info("=" * 60)
        logger.info("I.N.T.E.L.L.I.O is online and ready!")
